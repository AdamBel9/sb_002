...
public class Sb002Application implements WebMvcConfigurer  {
	...
	public static void main(String[] args) {
	  ...
	  @Bean public LocaleResolver localeResolver() { SessionLocaleResolver slr =new
	  ...
	  ici.setParamName("lang"); return ici ; } 
